        ...
        <div class="row justify-content-between align-items-center">
            <div
                ...
                <div class="d-inline-block">
                    <h5 class="h4 d-inline-block font-weight-400 mb-0 text-white">Mes services</h5>
                </div>
                <!-- Additional info -->
                        ...
                        <th scope="row">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body ml-4">
                                    <a href="/services/{{$service->id}}" class="name mb-0 h6 text-sm"> {{$service->product->name}}</a>
                                </div>
                            </div>
                        </th>
