            ...
            <div class="row justify-content-between align-items-center">
                <div
                    ...
                    <div class="d-inline-block">
                        <h5 class="h4 d-inline-block font-weight-400 mb-0 text-white">{{$service->hostname}} ({{$service->customer->first_name}} {{$service->customer->last_name}})</h5>
                    </div>
                    <!-- Additional info -->
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <form method="POST" action="/admin/suspend/{{$service->id}}">
                                    @csrf
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <span class="form-control-label">Adresse email:</span>
                                    </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-right">
                                        {{Str::lower($service->customer->last_name.$service->customer->first_name.$service->customer->id)}}
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-right">
                                        <span class="spoiler2">{{$service->customer->plesk_password}}</span>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item px-0">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-right">
                                        <a target="_blank"
                                           href="https://storm.lunafy.fr/login_up.php?login_name={{Str::lower($service->customer->last_name.$service->customer->first_name.$service->customer->id)}}&passwd={{$service->customer->plesk_password}}"
