    ...
    <div class="container position-relative zindex-100">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 px-5 px-lg-0">
                ...
                <a href="https://my.lunafy.fr   " class="btn btn-white btn-icon rounded-pill hover-translate-y-n3">
                    <span class="btn-inner--icon"><i class="far fa-home"></i></span>
                    <span class="btn-inner--text">Retourner à l'accueil</span>
                </a>
            </div>
            <div class="col-lg-6 d-none d-lg-block">
                <figure class="w-100">
                    <img alt="Image placeholder" src="/img/svg/illustrations/design-thinking.svg"
